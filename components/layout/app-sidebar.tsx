...
export function AppSidebar({ navItems = items, className }: AppSidebarProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed top-0 bottom-0 left-0 z-40 flex flex-col w-64 bg-sidebar-background border-r border-sidebar-border transition-transform duration-300 ease-in-out h-full",
