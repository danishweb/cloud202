...
import { createConfigurationSchema, configurationsListResponseSchema } from '@/lib/schemas';
...
export async function GET() {
  try {
    ...
    const validationResult = configurationsListResponseSchema.safeParse(configurations);
